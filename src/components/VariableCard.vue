<template>
  <div class="data">
    ...
    <div class="data__lower">
      <div class="data__lower__title">{{ this.$t('variable.main.' + variable + '.name') }}</div>
      <div class="data__lower__content">{{ this.$t('variable.main.' + variable + '.desc') }}</div>
    </div>
  </div>
</template>
...
.data {
  ...
  &__upper {
    ...
    &__icon {
      width: 42px;
      height: 42px;
      background-color: var(--lighter_tr);
      border-radius: 12px;
      display: flex;
